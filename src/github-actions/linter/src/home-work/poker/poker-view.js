...
export class PokerView {
    ...
    constructor() {
        ...
        this.hand1Container = document.getElementById('hand1-container');
        this.hand2Container = document.getElementById('hand2-container');
        this.resultContainer = document.getElementById('result-container');
        // Añadir eventos a los botones
        const dealHand1Button = document.getElementById('deal-hand1');
        const dealHand2Button = document.getElementById('deal-hand2');
